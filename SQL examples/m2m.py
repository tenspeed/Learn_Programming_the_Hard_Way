...
from sqlalchemy import create_engine, MetaData, Table, Column, Integer, String, DateTime, Float, ForeignKey, and_
...
if __name__ == '__main__':
	...
	q = session.query(OrderItem).all()

	print([(order.order_id, order.item_id) for order in q])